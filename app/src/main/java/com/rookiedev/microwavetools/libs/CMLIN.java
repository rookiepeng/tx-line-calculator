...
public class CMLIN {
    ...
    public CMLIN(double width, double space, double length, double impedance, double waveNumber, double impedanceOdd, double impedanceEven, double electricalLength, double frequency, double epsilon, double height, double thick, boolean usez0k) {
        W = width;
        S = space;
        L = length;
        Z0 = impedance;
