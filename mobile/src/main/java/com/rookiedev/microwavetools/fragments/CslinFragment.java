...
public class CslinFragment extends Fragment {
    ...
    private TextInputEditText editTextW, editTextG, editTextL, editTextZ0, editTextK, editTextZ0o, editTextZ0e, editTextPhs, editTextFreq, editTextT, editTextH, editTextEr;
    private TextInputLayout textInputLayoutT, textInputLayoutH, textInputLayoutW, textInputLayoutG, textInputLayoutZ0, textInputLayoutK, textInputLayoutZ0o, textInputLayoutZ0e, textInputLayoutEr, textInputLayoutF;
    private Button buttonSynthesize, buttonAnalyze;
    private AutoCompleteTextView spinnerW, spinnerG, spinnerL, spinnerT, spinnerH, spinnerZ0, spinnerZ0o, spinnerZ0e, spinnerPhs, spinnerFreq;
    ...
    public void onStop() {
        ...
        editor.putString(Constants.CSLIN_W, Objects.requireNonNull(editTextW.getText()).toString());
        editor.putString(Constants.CSLIN_W_UNIT, spinnerW.getText().toString());
        editor.putString(Constants.CSLIN_S, Objects.requireNonNull(editTextG.getText()).toString());
        editor.putString(Constants.CSLIN_S_UNIT, spinnerG.getText().toString());
        editor.putString(Constants.CSLIN_L, Objects.requireNonNull(editTextL.getText()).toString());
        editor.putString(Constants.CSLIN_L_UNIT, spinnerL.getText().toString());
        editor.putString(Constants.CSLIN_Z0, Objects.requireNonNull(editTextZ0.getText()).toString());
        editor.putString(Constants.CSLIN_Z0_UNIT, spinnerZ0.getText().toString());
        editor.putString(Constants.CSLIN_K, Objects.requireNonNull(editTextK.getText()).toString());
        editor.putString(Constants.CSLIN_Z0E, Objects.requireNonNull(editTextZ0e.getText()).toString());
        editor.putString(Constants.CSLIN_Z0E_UNIT, spinnerZ0e.getText().toString());
        editor.putString(Constants.CSLIN_Z0O, Objects.requireNonNull(editTextZ0o.getText()).toString());
        editor.putString(Constants.CSLIN_Z0O_UNIT, spinnerZ0o.getText().toString());
        editor.putString(Constants.CSLIN_PHS, Objects.requireNonNull(editTextPhs.getText()).toString());
        editor.putString(Constants.CSLIN_PHS_UNIT, spinnerPhs.getText().toString());
        editor.putString(Constants.CSLIN_FREQ, Objects.requireNonNull(editTextFreq.getText()).toString());
        editor.putString(Constants.CSLIN_FREQ_UNIT, spinnerFreq.getText().toString());
        editor.putString(Constants.CSLIN_ER, Objects.requireNonNull(editTextEr.getText()).toString());
        editor.putString(Constants.CSLIN_H, Objects.requireNonNull(editTextH.getText()).toString());
        editor.putString(Constants.CSLIN_H_UNIT, spinnerH.getText().toString());
        editor.putString(Constants.CSLIN_T, Objects.requireNonNull(editTextT.getText()).toString());
    ...
    private void synthesizeButton() {
        ...
        if (line.getErrorCode() == Constants.ERROR.NO_ERROR) {
            ...
            if ((Double.isNaN(line.getMetalWidth()) || Double.isInfinite(line.getMetalWidth())) || (Double.isNaN(line.getMetalSpace()) || Double.isInfinite(line.getMetalSpace()))) {
                editTextW.setText("");
