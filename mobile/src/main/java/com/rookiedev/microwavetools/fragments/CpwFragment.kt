...
class CpwFragment : Fragment() {
    ...
    private var radioButtonG: RadioButton? = null
    private var radioButtonH: RadioButton? = null
    private var withGround = false
    private var line: CpwModel? = null
    private var defaultEditTextColor: ColorStateList? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        if (getArguments() != null) {
            withGround = getArguments()!!.getString(Constants.PARAMS_CPW) == Constants.GROUNDED_CPW
        }
    }
                ...
                if (!withGround) {
                    line!!.setMetalThick(
                        Objects.requireNonNull<Editable?>(editTextT!!.getText()).toString()
                            .toDouble(), spinnerT!!.getText().toString()
                    )
                } else {
                    line!!.setMetalThick(0.0, spinnerT!!.getText().toString())
                }
            ...
            if (synthesizeInputCheck()) {
                ...
                if (target == Constants.Synthesize_Width) {
                    ...
                    line!!.setMetalSpace(
                        Objects.requireNonNull<Editable?>(editTextG!!.getText()).toString()
                            .toDouble(), spinnerG!!.getText().toString()
                    )
                    line!!.subEpsilon =
                ...
                if (line!!.errorCode == Constants.ERROR.NO_ERROR) {
                    ...
                    if (target == Constants.Synthesize_Width) {
                        ...
                        if ((Double.isNaN(line!!.metalSpace) || Double.isInfinite(line!!.metalSpace))) {
                            editTextG!!.setText("")
                            ...
                            val S = S_temp.setScale(Constants.DecimalLength, RoundingMode.HALF_UP)
                                .toDouble()
    ...
    private fun initUI() {
        ...
        radioButtonG = viewRoot!!.findViewById<RadioButton>(R.id.radioBtn_g)
    ...
    private fun readSharedPref() {
        ...
        if (withGround) {
            ...
            spinnerW!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.GCPW_W_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerG!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.GCPW_S_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerL!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.GCPW_L_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerZ0!!.setText(
                Constants.validateUnit(
                    Constants.adapterImpedanceUnits(mContext!!), prefs.getString(
                        Constants.GCPW_Z0_UNIT, Constants.ImpedanceUnit_Ohm
                    )!!
                ), false
            )
            ...
            spinnerPhs!!.setText(
                Constants.validateUnit(
                    Constants.adapterPhaseUnits(mContext!!), prefs.getString(
                        Constants.GCPW_PHS_UNIT, Constants.PhaseUnit_Degree
                    )!!
                ), false
            )
            ...
            spinnerFreq!!.setText(
                Constants.validateUnit(
                    Constants.adapterFrequencyUnits(mContext!!), prefs.getString(
                        Constants.GCPW_FREQ_UNIT, Constants.FreqUnit_GHz
                    )!!
                ), false
            )
            ...
            spinnerH!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.GCPW_H_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
        } else {
            ...
            spinnerW!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.CPW_W_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerG!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.CPW_S_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerL!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.CPW_L_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerZ0!!.setText(
                Constants.validateUnit(
                    Constants.adapterImpedanceUnits(mContext!!), prefs.getString(
                        Constants.CPW_Z0_UNIT, Constants.ImpedanceUnit_Ohm
                    )!!
                ), false
            )
            ...
            spinnerPhs!!.setText(
                Constants.validateUnit(
                    Constants.adapterPhaseUnits(mContext!!), prefs.getString(
                        Constants.CPW_PHS_UNIT, Constants.PhaseUnit_Degree
                    )!!
                ), false
            )
            ...
            spinnerFreq!!.setText(
                Constants.validateUnit(
                    Constants.adapterFrequencyUnits(mContext!!), prefs.getString(
                        Constants.CPW_FREQ_UNIT, Constants.FreqUnit_GHz
                    )!!
                ), false
            )
            ...
            spinnerH!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.CPW_H_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
            ...
            spinnerT!!.setText(
                Constants.validateUnit(
                    Constants.adapterDimensionUnits(mContext!!), prefs.getString(
                        Constants.CPW_T_UNIT, Constants.LengthUnit_mm
                    )!!
                ), false
            )
        }
    ...
    private fun setRadioBtn() {
        ...
        radioButtonG!!.setOnClickListener(View.OnClickListener { arg0: View? ->
            radioButtonW!!.setChecked(false)
            editTextW!!.setBackgroundTintList(
                AppCompatResources.getColorStateList(
                    mContext!!,
    ...
    override fun onStop() {
        ...
        if (withGround) {
            ...
            editor.putString(Constants.GCPW_TARGET, target.toString())
        } else {
            editor.putString(
                Constants.CPW_W,
                Objects.requireNonNull<Editable?>(editTextW!!.getText()).toString()
            ...
            editor.putString(Constants.CPW_TARGET, target.toString())
        }
        editor.apply()
    }
