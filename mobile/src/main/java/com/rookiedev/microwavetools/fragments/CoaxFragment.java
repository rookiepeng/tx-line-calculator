...
public class CoaxFragment extends Fragment {
    ...
    public void onStop() {
        ...
        editor.putString(Constants.COAX_B, Objects.requireNonNull(editTextB.getText()).toString());
        editor.putString(Constants.COAX_B_UNIT, spinnerB.getText().toString());
        editor.putString(Constants.COAX_C, Objects.requireNonNull(editTextC.getText()).toString());
        editor.putString(Constants.COAX_C_UNIT, spinnerC.getText().toString());
        editor.putString(Constants.COAX_ER, Objects.requireNonNull(editTextEr.getText()).toString());
        editor.putString(Constants.COAX_L, Objects.requireNonNull(editTextL.getText()).toString());
        editor.putString(Constants.COAX_L_UNIT, spinnerL.getText().toString());
        editor.putString(Constants.COAX_Z0, Objects.requireNonNull(editTextZ0.getText()).toString());
        editor.putString(Constants.COAX_Z0_UNIT, spinnerZ0.getText().toString());
        editor.putString(Constants.COAX_PHS, Objects.requireNonNull(editTextPhs.getText()).toString());
        editor.putString(Constants.COAX_PHS_UNIT, spinnerPhs.getText().toString());
        editor.putString(Constants.COAX_FREQ, Objects.requireNonNull(editTextFreq.getText()).toString());
