...
public class SlinFragment extends Fragment {
    ...
    public void onStop() {
        ...
        editor.putString(Constants.SLIN_W_UNIT, Integer.toString(spinnerW.getListSelection()));
        editor.putString(Constants.SLIN_H, editTextH.getText().toString());
        editor.putString(Constants.SLIN_H_UNIT, Integer.toString(spinnerH.getListSelection()));
        ...
        editor.putString(Constants.SLIN_L_UNIT, Integer.toString(spinnerL.getListSelection()));
        editor.putString(Constants.SLIN_Z0, editTextZ0.getText().toString());
        editor.putString(Constants.SLIN_Z0_UNIT, Integer.toString(spinnerZ0.getListSelection()));
        editor.putString(Constants.SLIN_PHS, editTextPhs.getText().toString());
        editor.putString(Constants.SLIN_PHS_UNIT, Integer.toString(spinnerPhs.getListSelection()));
        editor.putString(Constants.SLIN_FREQ, editTextFreq.getText().toString());
        editor.putString(Constants.SLIN_FREQ_UNIT, Integer.toString(spinnerFreq.getListSelection()));
        editor.putString(Constants.SLIN_T, editTextT.getText().toString());
        editor.putString(Constants.SLIN_T_UNIT, Integer.toString(spinnerT.getListSelection()));
